...
public class ZAxisParticle extends SpriteBillboardParticle {
    private int delay;

    ZAxisParticle(ClientWorld world, double x, double y, double z, int delay, SpriteProvider spriteProvider) {
        super(world, x, y, z);
        this.scale = 0.0F;
        this.delay = delay;
    ...
    public void buildGeometry(VertexConsumer vertexConsumer, Camera camera, float tickDelta) {
        ...
        this.buildGeometry(vertexConsumer, camera, tickDelta, (quaternion) -> {
            quaternion.mul(new Quaternionf().rotationY((float) Math.PI));
        });
    }
    ...
    public static class Factory implements ParticleFactory<DefaultParticleType> {
        ...
        public Particle createParticle(DefaultParticleType particleType, ClientWorld clientWorld,
            ...
            ZAxisParticle particle = new ZAxisParticle(clientWorld, d, e, f, 0, this.spriteProvider);
