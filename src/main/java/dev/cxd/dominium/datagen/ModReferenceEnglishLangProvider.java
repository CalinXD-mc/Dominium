...
public class ModReferenceEnglishLangProvider extends FabricLanguageProvider {
    ...
    public void generateTranslations(TranslationBuilder translationBuilder) {
        ...
        translationBuilder.add("item.dominium.contract_soulbound", "Dominic Contract");
        translationBuilder.add("item.dominium.contract_signed_soulbound", "Dominic Contract");
        ...
        translationBuilder.add("item.dominium.ancient_bone_alloy", "Dominic Alloy Ingot");
        translationBuilder.add("item.dominium.ancient_bone_alloy_chunk", "Dominic Alloy Chunk");
