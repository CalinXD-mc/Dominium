...
public class SoultrapSpetumItem extends SwordItem implements MarkableItem {
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity player, Hand hand) {
        ...
        if (!player.isOnGround() && !ModConfig.doesTheSoultrapSpetumWorkWithElytras && player.isFallFlying()) {
    ...
    public void inventoryTick(ItemStack stack, World world, Entity entity, int slot, boolean selected) {
        ...
        if (hasSlam && downward) {
            ...
            int slamTicks = nbt.getInt("SlamTicks") + 1;
            nbt.putInt("SlamTicks", slamTicks);
