...
public class UndeadNecklaceItem extends TrinketItem implements MarkableItem, ParticleEmitterHandler.ItemParticleSupplier {
    ...
    public void spawnLateParticles(ScreenParticleHolder target, World level, float partialTick, ItemStack stack, float x, float y) {
        ScreenParticleEffects.spawnZombieNecklaceParticle(target, level, 0.75f, partialTick);
    }
}
