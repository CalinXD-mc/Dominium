...
public class WandererTabletSigned extends CustomRarityItem {
    public WandererTabletSigned(Settings settings, ModRarities rarity) {
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        ...
        if ((desc == null || desc.isEmpty()) && (debugOne == null || debugOne.isEmpty())) {
            ...
            if (desc != null && !desc.isEmpty()) {
                tooltip.add(Text.literal("Bound to " + desc).formatted(Formatting.AQUA));
            }
